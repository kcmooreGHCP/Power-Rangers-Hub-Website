(function () {
  ...
  const answers = [
    ...
    { keys:["set irl","field feedback","store voice"], answer:"SET IRL is the field return path. It captures what worked, what created friction, time spent, and field ideas so planned work can learn from physical execution.", source:"SET Loop · SET IRL field return", link:"../store-ops/SET_LOOP_MASTER.html#set-irl", label:"Open SET IRL" },
